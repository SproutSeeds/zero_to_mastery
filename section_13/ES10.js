...
// Object.fromEntries(array) will turn an array into an obj
const objFromEntries = Object.fromEntries(userProfiles);
...
try {
  ...
  console.log(
    'We are now in the catch blog! Nice Catch! Your error is described as ',
    error
  );
}
